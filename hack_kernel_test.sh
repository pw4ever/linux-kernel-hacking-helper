...
qemu-system-x86_64 -kernel ${target_dir}/vmlinuz -initrd ${target_dir}/initramfs-linux -hda ${image_dir}/${image}.img -append "root=$(cat ${image_dir}/${image}.uuid) ${append_opt}" $*
